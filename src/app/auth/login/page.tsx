      ...
      >
        <div className="bg-white border border-pink-100 rounded-2xl p-8 shadow-soft">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-display tracking-tight text-ink">Welcome Back</h1>
            <p className="text-sm text-muted mt-1">Sign in to {SITE_NAME}</p>
          </div>
          ...
          <p className="text-xs text-muted text-center mt-6">
            ...
            <Link href="/auth/register" className="text-pink-600 font-medium hover:text-pink-700 transition-colors underline underline-offset-2">
              Create one
            </Link>
          </p>
        </div>
